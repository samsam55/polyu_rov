...
const int ARM[ ARMOUTSIZE ][ ARMINSIZE ] = {    { 50,  52 },   { 46, 48  },   { 42,  44 }, {36, 38},{34,28}};
// Bitstream memory.
//                      Cam1 Cam2 Cam3 Cam4 Cam5 Cam6 Cam7 Cam8
byte cam[ CAMSIZE ] = {    0,   0,   0,   0,   0,   0,   0,   0 }; // 0s' will be changed to [0,180].
//                          Cylinder Gripper1 Gripper2
byte valve[ VALVESIZE ] = {        0,       0,       0 };          // 0s' will be changed to [0,1].
//                         Arm1 Arm2 Arm3 Arm4
