...
const int CAM[ CAMSIZE ] = {   A0,  A1,  A2,  A6,  A5,  A3,  A4,  A7 };
//                               Gripper1 Cylinder Gripper2
const int VALVE[ VALVESIZE ] = {   32   ,      30 };
//                                             Arm1 UP DOWN   Arm2 UP DOWN   Arm3 UP DOWN Arm4 UP DOWN
const int ARM[ ARMOUTSIZE ][ ARMINSIZE ] = {  { 42,  44 }, { 50,  52 },  {36, 38},  { 48, 46  },   {28, 34},  {32, 30},  {34, 28}};
// Bitstream memory.
//                      Cam1 Cam2 Cam3 Cam4 Cam5 Cam6 Cam7 Cam8
...
//                         Arm1 Arm2 Arm3 Arm4
byte arm[ ARMOUTSIZE ] = {    0,   0,   0 , 0, 0, 0, 0};                   // arm1-4 0s' will be changed to [0,2].
